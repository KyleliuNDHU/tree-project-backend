...
CREATE TABLE `tree_species` (
  `id` varchar(10) NOT NULL COMMENT '樹種編號',
  `name` varchar(50) NOT NULL COMMENT '樹種名稱',
  `scientific_name` varchar(100) DEFAULT NULL COMMENT '學名',
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='樹種資料表';

--
-- 傾印資料表的資料 `tree_species`
--
